# WARNING: EARLY PROOF OF CONCEPT RELEASE, NOT FOR PRODUCTION USE!

THIS MODULE IS A WORK IN PROGRESS. DO NOT USE THIS MODULE FOR ANYTHING APART
FROM TESTING PURPOSES. IT'S ALSO MORE THAN LIKELY THAT MANY DETAILS INCLUDING
(BUT NOT LIMITED TO) DATABASE STRUCTURE USED MAY CHANGE BEFORE FINAL RELEASE,
RESULTING IN LOSS OF DATA.

FOR PRODUCTION READY VERSION CONTROL MODULE FOR PROCESSWIRE PLEASE CHECK OUT
VERSION CONTROL FOR TEXT FIELDS, WHICH CAN BE FOUND FROM PROCESSWIRE MODULES
DIRECTORY.
