...
THIS MODULE IS A WORK IN PROGRESS. DO NOT USE FOR ANYTHING APART FROM TESTING
PURPOSES. IT'S ALSO POSSIBLE THAT MANY DETAILS INCLUDING (BUT NOT LIMITED TO)
DATABASE STRUCTURE MAY CHANGE BEFORE FINAL RELEASE RESULTING IN LOSS OF DATA.

FOR PRODUCTION READY VERSION CONTROL MODULE FOR PROCESSWIRE PLEASE CHECK OUT
VERSION CONTROL FOR TEXT FIELDS, FOUND FROM PROCESSWIRE MODULES DIRECTORY.
